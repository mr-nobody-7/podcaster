    ...
    <section>
      ...
      <Form {...form}>
        <form
          ...
          className="mt-12 w-full flex-col"
        >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  <FormLabel className="font-16 text-bold text-white-1">
                    Podcast Title
                  </FormLabel>
                  <FormControl>
                    <Input
          ...
          <div className="flex flex-col pt-10">
            ...
            <div className="mt-10 w-full">
              <Button
                type="submit"
                className="text-16 py-4 font-extrabold w-full text-white-1 bg-orange-1 transition-all duration-500 hover:bg-black-1"
              >
                {isSubmitting ? (
                  <>
                    Submitting
